...
const TREES = [
  ...
  { name: 'Chemistry', column: 'gathering', icon: '⚗️', desc: 'Potion and brewing mastery — leveled by brewing (50 to 1.25k). Vanilla brewing contributes at 20:1 ratio. Ingredient Binder at level 1.', scaling: (lv: number) => `Brew skill ${lv}`, prestige: ['Volatile Mix — 10% chance for double potion output', 'Pure Distillation — potions last 25% longer', '...the bubbles speak to you now. You understand.'] },
