...
data modify entity @e[type=hopper_minecart,tag=ec.temp_cart,limit=1] Items[0].components."minecraft:custom_data" merge value {ancient_netherite_core:1b,primary:1}
...
tellraw @s ["",{text:"Primary effect set to ",color:"gray"},{text:"Speed",color:"aqua",bold:true}]
