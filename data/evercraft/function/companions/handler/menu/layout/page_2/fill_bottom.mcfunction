data modify entity @s Items set from storage evercraft:companions MenuPage2
...
data modify entity @s Items append from storage evercraft:companions constants.pages[0]
