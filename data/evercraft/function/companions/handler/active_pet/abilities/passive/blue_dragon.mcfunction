...
# - Void Strike: Attack damage in The End
# - Void Shield: Absorption shield (schedule trigger)

function evercraft:companions/handler/active_pet/abilities/trigger/blue_dragon
tag @s add Pets.Blue_Dragon
execute unless dimension the_end run return fail
