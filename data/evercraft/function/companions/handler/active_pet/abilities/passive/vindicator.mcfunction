# Vindicator Pet Passive Abilities
# - Raider's Fury: Attack damage + attack speed dual scaling
# - Sweeping Edge: Sweeping damage on all attacks
...
execute if score #value Pets.Calc matches 8..12 run attribute @s attack_speed base set 4.174
execute if score #value Pets.Calc matches 13..17 run attribute @s attack_speed base set 4.247
execute if score #value Pets.Calc matches 18..22 run attribute @s attack_speed base set 4.321
execute if score #value Pets.Calc matches 23..27 run attribute @s attack_speed base set 4.395
execute if score #value Pets.Calc matches 28..32 run attribute @s attack_speed base set 4.468
execute if score #value Pets.Calc matches 33..37 run attribute @s attack_speed base set 4.542
execute if score #value Pets.Calc matches 38..42 run attribute @s attack_speed base set 4.616
execute if score #value Pets.Calc matches 43..47 run attribute @s attack_speed base set 4.689
execute if score #value Pets.Calc matches 48..52 run attribute @s attack_speed base set 4.763
execute if score #value Pets.Calc matches 53..57 run attribute @s attack_speed base set 4.837
execute if score #value Pets.Calc matches 58..62 run attribute @s attack_speed base set 4.911
execute if score #value Pets.Calc matches 63..67 run attribute @s attack_speed base set 4.984
execute if score #value Pets.Calc matches 68..72 run attribute @s attack_speed base set 5.058
execute if score #value Pets.Calc matches 73..77 run attribute @s attack_speed base set 5.132
execute if score #value Pets.Calc matches 78..82 run attribute @s attack_speed base set 5.205
execute if score #value Pets.Calc matches 83..87 run attribute @s attack_speed base set 5.279
execute if score #value Pets.Calc matches 88..92 run attribute @s attack_speed base set 5.353
execute if score #value Pets.Calc matches 93..97 run attribute @s attack_speed base set 5.426
execute if score #value Pets.Calc matches 98..100 run attribute @s attack_speed base set 5.5

tag @s add Pets.Vindicator
