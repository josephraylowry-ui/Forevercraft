# Hero's Satchel — Apply effects from all slots of one bag (macro)
# 11 slots (s0-s10), AoE effects are applied here
...
execute if data storage evercraft:hero_satchel temp.artifact run function evercraft:hero_satchel/apply_slot with storage evercraft:hero_satchel temp
