# Harmonize — Count harmonizable artifacts from all slots of one satchel bag (macro)
...
execute if data storage evercraft:satchel temp.artifact run function evercraft:harmonize/count_satchel_artifact
