# Party GUI — Party Ping Button Click
...
# Execute ping as the player
execute as @a[tag=Adv.InMenu,distance=..10] if score @s adv.gui_session = #gui_click_sess ec.temp at @s run function evercraft:party/ping
