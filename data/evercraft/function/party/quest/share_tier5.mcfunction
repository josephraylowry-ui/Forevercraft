# Share Tier 5 kill quest progress with party members
# Run as player with kill quest in tier 5
...
execute store result storage evercraft:party temp.qid int 1 run scoreboard players get @s ec.quest_id_5

# Find maximum progress among nearby party members with same quest
function evercraft:party/quest/share_tier5_macro with storage evercraft:party temp
