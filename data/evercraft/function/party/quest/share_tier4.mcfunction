# Share Tier 4 kill quest progress with party members
# Run as player with kill quest in tier 4
...
execute store result storage evercraft:party temp.qid int 1 run scoreboard players get @s ec.quest_id_4

# Find maximum progress among nearby party members with same quest
function evercraft:party/quest/share_tier4_macro with storage evercraft:party temp
