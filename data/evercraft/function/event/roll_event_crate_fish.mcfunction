...
execute if score #roll ec.temp matches 1..700 if score #inv_full ec.var matches 1 at @s run loot spawn ~ ~ ~ loot evercraft:fishing/gameplay/fishing/crates/ornate/1
# Exquisite (701-980)
...
execute if score #roll ec.temp matches 701..980 if score #inv_full ec.var matches 1 at @s run loot spawn ~ ~ ~ loot evercraft:fishing/gameplay/fishing/crates/exquisite/1
# Mythical (981-1000 = 2%)
...
execute if score #roll ec.temp matches 981.. if score #inv_full ec.var matches 1 at @s run loot spawn ~ ~ ~ loot evercraft:fishing/gameplay/fishing/crates/mythical/1
