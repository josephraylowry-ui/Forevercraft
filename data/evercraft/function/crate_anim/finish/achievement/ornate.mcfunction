...
data merge block ~ ~ ~ {CustomName:{text:"Ornate Achievement Crate",color:"dark_purple",italic:false}}
particle minecraft:firework ~ ~0.5 ~ 0.5 0.5 0.5 0 80 force
playsound minecraft:entity.firework_rocket.blast ambient @a[distance=..16] ~ ~ ~ 0.7
