# Fishing Crate Finish — Uncommon
# Run as animation armor_stand, at the barrel position

data remove block ~ ~ ~ lock
data merge block ~ ~ ~ {CustomName:{text:"Uncommon Fishing Crate",color:"blue",italic:false}}
...
tellraw @p[distance=..20] [{text:"[Crates] ",color:"blue"},{text:"An Uncommon Fishing Crate has appeared!",color:"blue"}]
