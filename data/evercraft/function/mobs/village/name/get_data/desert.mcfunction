...
execute store result storage eden:temp village.desert.id int 1 run random value 1..250
...
function evercraft:mobs/village/name/set_name with storage eden:temp village.desert
