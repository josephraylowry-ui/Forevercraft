...
execute if score $unique_playerhead_id mob_manager.playerhead.id matches 1 store result storage eden:temp mob_manager.head.playerhead.rolled_id int 1 run function evercraft:mobs/mob_equipment/playerheads/get_storage_entry with storage eden:temp mob_manager.head.playerhead
...
execute if score $unique_playerhead_id mob_manager.playerhead.id matches 2.. run function evercraft:mobs/mob_equipment/playerheads/get_random_player with storage eden:temp mob_manager.head.playerhead