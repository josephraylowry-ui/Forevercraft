...
tellraw @a[distance=..64] [{text:"[",color:"dark_gray"},{text:"Forevercraft",color:"gold",bold:true},{text:"] ",color:"dark_gray"},{text:"Armored Ender Dragon Wings",color:"gold"},{text:" have been separated back into ",color:"gray"},{text:"Ender Dragon Chestplate",color:"gold"},{text:" and ",color:"gray"},{text:"Ender Dragon Wings",color:"gold"},{text:"!",color:"gray"}]
