# Change villager to Nymph profession
# Nature spirit who trades Tree Tokens for powerful consumables and rewards
tag @s add more_professions_verified
tag @s add more_professions_nymph

# Set custom name and ensure all trade tiers are visible (level 5 = master)
data modify entity @s CustomName set value {text:"Nymph",color:"dark_green",bold:true}
...
# Setup trades
function evercraft:professions/jobs/nymph/setup_all_trades
