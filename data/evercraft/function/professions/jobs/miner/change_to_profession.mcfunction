# Change villager to Spelunker profession
tag @s add more_professions_verified
tag @s add more_professions_miner

# Set custom name and ensure all trade tiers are visible (level 5 = master)
data modify entity @s CustomName set value {text:"Spelunker",color:"dark_gray",bold:true}
...
# Setup trades
function evercraft:professions/jobs/miner/setup_all_trades
