...
execute if score @s more_professions_binary matches 16.. run scoreboard players remove @s more_professions_binary 16
execute if score @s more_professions_binary matches 8.. run scoreboard players remove @s more_professions_binary 8
execute if score @s more_professions_binary matches 4.. run scoreboard players remove @s more_professions_binary 4
execute if score @s more_professions_binary matches 2.. run scoreboard players remove @s more_professions_binary 2
execute if score @s more_professions_binary matches 0 run function evercraft:professions/jobs/circut_board/set/redstone_dust