# Change villager to Apiarist profession
tag @s add more_professions_verified
tag @s add more_professions_beekeeper

# Set custom name and ensure all trade tiers are visible (level 5 = master)
data modify entity @s CustomName set value {text:"Apiarist",color:"yellow",bold:true}
