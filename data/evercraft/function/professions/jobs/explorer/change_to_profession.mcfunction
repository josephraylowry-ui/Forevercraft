# Change villager to Explorer profession
tag @s add more_professions_verified
tag @s add more_professions_explorer

# Set custom name and ensure all trade tiers are visible (level 5 = master)
data modify entity @s CustomName set value {text:"Expeditionist",color:"aqua",bold:true}
