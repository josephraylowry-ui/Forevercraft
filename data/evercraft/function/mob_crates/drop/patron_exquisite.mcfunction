...
execute if score @s mt.charm_timer matches 1.. if predicate {"condition":"minecraft:random_chance","chance":0.75} run function evercraft:mob_crates/spawn/exquisite
