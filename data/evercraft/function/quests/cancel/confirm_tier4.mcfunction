...
execute unless score @s ec.quest_id_4 matches 1.. run tellraw @s ["",{text:"[Quests] ",color:"gold"},{text:"You don't have a Commission to cancel.",color:"gray"}]
...
tellraw @s ["",{text:"[Quests] ",color:"gold"},{text:"Commission cancelled. ",color:"yellow"},{text:"-40 reputation.",color:"red"}]
