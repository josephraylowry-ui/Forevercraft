...
attribute @s[scores={mt.assa_rune=1}] attack_damage modifier remove mt.assassin_rune
attribute @s[scores={mt.assa_rune=1}] movement_speed modifier remove mt.assassin_rune
