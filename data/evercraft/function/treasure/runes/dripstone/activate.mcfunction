...
execute at @e[type=armor_stand,tag=mt.stalactite,limit=1,distance=..1] run function evercraft:treasure/runes/dripstone/stalactite
kill @e[type=armor_stand,tag=mt.stalactite,limit=1,sort=nearest]

function evercraft:treasure/runes/dripstone/particles

advancement revoke @s only evercraft:treasure/runes/dripstone_rune