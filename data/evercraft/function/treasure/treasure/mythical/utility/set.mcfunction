...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"evercraft:treasure/chests/mythical/utility",CustomName:{text:" Mythical Utility Treasure",color:"#8d0000",bold:false,italic:false}} destroy
