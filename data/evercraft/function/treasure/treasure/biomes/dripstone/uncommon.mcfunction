...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"evercraft:treasure/chests/dripstone/uncommon",CustomName:{text:"  Uncommon Dripstone Treasure",color:"blue",bold:false,italic:false}} destroy
