...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"evercraft:treasure/chests/desert/uncommon",CustomName:{text:"  Uncommon Desert Treasure",color:"blue",bold:false,italic:false}} destroy
