...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"evercraft:treasure/chests/desert/ornate",CustomName:{text:"      Ornate Desert Treasure",color:"dark_red",bold:false,italic:false}} destroy
