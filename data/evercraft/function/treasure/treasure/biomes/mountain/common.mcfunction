...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"evercraft:treasure/chests/mountain/common",CustomName:{text:"   Common Mountain Treasure",color:"white",bold:false,italic:false}} destroy
