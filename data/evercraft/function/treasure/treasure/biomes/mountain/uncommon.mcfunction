...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"evercraft:treasure/chests/mountain/uncommon",CustomName:{text:"  Uncommon Mountain Treasure",color:"blue",bold:false,italic:false}} destroy
