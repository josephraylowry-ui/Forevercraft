...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"evercraft:treasure/chests/warped/common",CustomName:{text:"Common Warped Forest Treasure",color:"white",bold:false,italic:false}} destroy
