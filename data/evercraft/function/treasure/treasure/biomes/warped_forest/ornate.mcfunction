...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"evercraft:treasure/chests/warped/ornate",CustomName:{text:" Ornate Warped Forest Treasure",color:"dark_red",bold:false,italic:false}} destroy
