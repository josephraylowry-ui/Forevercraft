...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"evercraft:treasure/chests/warped/uncommon",CustomName:{text:"  Uncommon Warped Treasure",color:"blue",bold:false,italic:false}} destroy
