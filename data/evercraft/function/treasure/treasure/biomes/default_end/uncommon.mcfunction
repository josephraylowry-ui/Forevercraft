...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"evercraft:treasure/chests/end/uncommon",CustomName:{text:"  Uncommon End Treasure",color:"blue",bold:false,italic:false}} destroy
