...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"evercraft:treasure/chests/flower/uncommon",CustomName:{text:"  Uncommon Flower Treasure",color:"blue",bold:false,italic:false}} destroy
