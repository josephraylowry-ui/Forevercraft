...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"evercraft:treasure/chests/flower/ornate",CustomName:{text:"      Ornate Flower Treasure",color:"dark_red",bold:false,italic:false}} destroy
