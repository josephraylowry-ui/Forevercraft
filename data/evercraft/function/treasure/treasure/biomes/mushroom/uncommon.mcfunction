...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"evercraft:treasure/chests/mushroom/uncommon",CustomName:{text:"  Uncommon Mushroom Treasure",color:"blue",bold:false,italic:false}} destroy
