...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"evercraft:treasure/chests/basalt/uncommon",CustomName:{text:"  Uncommon Basalt Treasure",color:"blue",bold:false,italic:false}} destroy
