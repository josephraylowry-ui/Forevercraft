...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"evercraft:treasure/chests/deep_dark/uncommon",CustomName:{text:"  Uncommon Deep Dark Treasure",color:"blue",bold:false,italic:false}} destroy
