...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"evercraft:treasure/chests/deep_dark/common",CustomName:{text:"   Common Deep Dark Treasure",color:"white",bold:false,italic:false}} destroy
