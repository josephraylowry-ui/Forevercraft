...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"evercraft:treasure/chests/ocean/common",CustomName:{text:"     Common Ocean Treasure",color:"white",bold:false,italic:false}} destroy
