...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"evercraft:treasure/chests/ocean/uncommon",CustomName:{text:"  Uncommon Ocean Treasure",color:"blue",bold:false,italic:false}} destroy
