...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"evercraft:treasure/chests/lush_caves/common",CustomName:{text:" Common Lush Caves Treasure",color:"white",bold:false,italic:false}} destroy
