...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"evercraft:treasure/chests/soul_valley/uncommon",CustomName:{text:"  Uncommon Soul Valley Treasure",color:"blue",bold:false,italic:false}} destroy
