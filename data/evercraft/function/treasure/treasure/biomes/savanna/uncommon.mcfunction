...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"evercraft:treasure/chests/savanna/uncommon",CustomName:{text:"  Uncommon Savanna Treasure",color:"blue",bold:false,italic:false}} destroy
