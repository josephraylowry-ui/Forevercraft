...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"evercraft:treasure/chests/savanna/common",CustomName:{text:"   Common Savanna Treasure",color:"white",bold:false,italic:false}} destroy
