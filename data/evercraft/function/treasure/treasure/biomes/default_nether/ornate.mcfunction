...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"evercraft:treasure/chests/nether/ornate",CustomName:{text:"      Ornate Nether Treasure",color:"dark_red",bold:false,italic:false}} destroy
