...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"evercraft:treasure/chests/nether/uncommon",CustomName:{text:"  Uncommon Nether Treasure",color:"blue",bold:false,italic:false}} destroy
