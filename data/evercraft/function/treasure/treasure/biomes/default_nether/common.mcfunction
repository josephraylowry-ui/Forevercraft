...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"evercraft:treasure/chests/nether/common",CustomName:{text:"    Common Nether Treasure",color:"white",bold:false,italic:false}} destroy
