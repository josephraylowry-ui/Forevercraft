...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"evercraft:treasure/chests/jungle/uncommon",CustomName:{text:"  Uncommon Jungle Treasure",color:"blue",bold:false,italic:false}} destroy
