...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"evercraft:treasure/chests/jungle/common",CustomName:{text:"    Common Jungle Treasure",color:"white",bold:false,italic:false}} destroy
