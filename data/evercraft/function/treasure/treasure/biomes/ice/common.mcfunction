...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"evercraft:treasure/chests/ice/common",CustomName:{text:"       Common Ice Treasure",color:"white",bold:false,italic:false}} destroy
