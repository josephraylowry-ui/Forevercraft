...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"evercraft:treasure/chests/ice/uncommon",CustomName:{text:"  Uncommon Ice Treasure",color:"blue",bold:false,italic:false}} destroy
