...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"evercraft:treasure/chests/crimson/uncommon",CustomName:{text:"  Uncommon Crimson Treasure",color:"blue",bold:false,italic:false}} destroy
