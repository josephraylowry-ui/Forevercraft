...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"evercraft:treasure/chests/crimson/common",CustomName:{text:"Common Crimson Forest Treasure",color:"white",bold:false,italic:false}} destroy
