...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"evercraft:treasure/chests/default/common",CustomName:{text:"     Common Standard Treasure",color:"white",bold:false,italic:false}} destroy
