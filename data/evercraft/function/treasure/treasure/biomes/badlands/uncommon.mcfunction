...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"evercraft:treasure/chests/badlands/uncommon",CustomName:{text:"  Uncommon Badlands Treasure",color:"blue",bold:false,italic:false}} destroy
