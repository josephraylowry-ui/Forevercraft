...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"evercraft:treasure/chests/badlands/common",CustomName:{text:"   Common Badlands Treasure",color:"white",bold:false,italic:false}} destroy
