...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"evercraft:treasure/chests/wind/uncommon",CustomName:{text:"  Uncommon Wind Treasure",color:"blue",bold:false,italic:false}} destroy
