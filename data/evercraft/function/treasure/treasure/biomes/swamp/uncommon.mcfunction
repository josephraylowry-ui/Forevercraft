...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"evercraft:treasure/chests/swamp/uncommon",CustomName:{text:"  Uncommon Swamp Treasure",color:"blue",bold:false,italic:false}} destroy
