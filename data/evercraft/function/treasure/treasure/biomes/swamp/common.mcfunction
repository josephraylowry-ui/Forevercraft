...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"evercraft:treasure/chests/swamp/common",CustomName:{text:"     Common Swamp Treasure",color:"white",bold:false,italic:false}} destroy
