...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"evercraft:treasure/chests/taiga/uncommon",CustomName:{text:"  Uncommon Taiga Treasure",color:"blue",bold:false,italic:false}} destroy
