...
setblock ~ ~ ~ minecraft:barrel[facing=up]{LootTable:"evercraft:treasure/chests/taiga/common",CustomName:{text:"     Common Taiga Treasure",color:"white",bold:false,italic:false}} destroy
