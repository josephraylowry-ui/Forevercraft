...
execute if score @s mt.plot matches 1 run function evercraft:treasure/treasure/biomes/wind/mythical with entity @s equipment.feet.components."minecraft:custom_data"
