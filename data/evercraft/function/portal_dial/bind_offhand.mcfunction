# Portal Dial — Bind check (offhand)
# Player just right-clicked a lodestone while holding Portal Dial in offhand
...
item modify entity @s weapon.offhand {"function":"minecraft:set_custom_data","tag":"{portal_dial:1b,evercraft_item:1b,portal_dial_bound:1b,gs_bound_id:0}"}
