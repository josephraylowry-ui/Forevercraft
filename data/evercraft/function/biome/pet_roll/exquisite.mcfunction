...
execute if score @s ec.biome_id matches -1 run loot give @s loot evercraft:pets/exquisite
...
data modify storage evercraft:temp rarity set value "exquisite"
