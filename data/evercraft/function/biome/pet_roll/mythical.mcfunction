...
execute if score @s ec.biome_id matches -1 run loot give @s loot evercraft:pets/mythical
...
data modify storage evercraft:temp rarity set value "mythical"
